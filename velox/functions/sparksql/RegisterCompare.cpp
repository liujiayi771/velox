...
void registerCompareFunctions(const std::string& prefix) {
  ...
  registerFunction<
      ...
      bool,
      UnscaledLongDecimal,
      UnscaledLongDecimal>({prefix + "greaterthan"});
  registerFunction<
      LtFunction,
      bool,
      UnscaledShortDecimal,
  ...
  registerFunction<
      ...
      bool,
      UnscaledLongDecimal,
      UnscaledLongDecimal>({prefix + "lessthan"});
  registerFunction<
      GteFunction,
      bool,
      UnscaledShortDecimal,
  ...
  registerFunction<
      ...
      bool,
      UnscaledLongDecimal,
      UnscaledLongDecimal>({prefix + "greaterthanorequal"});
  registerFunction<
      LteFunction,
      bool,
      UnscaledShortDecimal,
  ...
  registerFunction<
      ...
      bool,
      UnscaledLongDecimal,
      UnscaledLongDecimal>({prefix + "lessthanorequal"});
}
